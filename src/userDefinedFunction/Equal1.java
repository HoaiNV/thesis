...
public class Equal1 extends AbstractInvariant implements IConstraint {
	...
	public Equal1(IFunction f1, IFunction f2) {
	...
	public Equal1(IFunction f1, VarIntLS x) {
		_ls = f1.getLocalSearchManager();
		_f1 = f1;
	...
	public Equal1(VarIntLS x, VarIntLS y) {
	...
	public Equal1(IFunction f1, int val) {
		_ls = f1.getLocalSearchManager();
		_f1 = f1;
	...
	public Equal1(VarIntLS x, int val) {
		_ls = x.getLocalSearchManager();
		_f1 = new FuncVarConst(x);
		_f2 = new FuncVarConst(_ls,val);
		post();
